...
## PHASE 7: CI/CD & GOVERNANCE AUTOMATION

- Evidence audit script: `python docs/audit_evidence_labels.py`
- DOI validation script: `python docs/validate_bibliography_dois.py`
- Hyper-strict enforcer: `python docs/evidence_enforcer.py`
- π self-heal hook (idempotent): `python docs/pi_self_heal_hooks.py`
- Sign-off template: `docs/validation/MERGE_SIGN_OFF_TEMPLATE.txt`
- Maintenance dashboard seed: `docs/maintenance/2026_q2_calibration.md`

These artifacts are required for merge readiness and post-merge operational governance.
