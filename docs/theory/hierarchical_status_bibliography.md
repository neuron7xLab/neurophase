# neurophase — компактна ієрархічно-статусна бібліографія

**Стандарт:** реплікованість, фальсифікованість, трасованість до коду.  
**Мета:** тримати аргументацію в продукті на тому самому рівні, що й
peer-reviewed research, без marketing-фрази «DeepMind/OpenAI level».

Це **супровідний** скорочений список. Повна, DOI-анотована, з
матрицею трасованості версія — у
[`neurophase_elite_bibliography.md`](neurophase_elite_bibliography.md).
Правила evidence labeling — у
